...
\supervisionA{Jonas Frey}
\supervisionB{Takahiro Miki}
...
% Bibliography
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% solve all the issues related to the bibliography by following this: https://tex.stackexchange.com/questions/168312/latex-warning-citation-undefined

\bibliographystyle{bibliography/IEEEtranN}
\bibliography{bibliography/SemesterThesis}
